...
<div class="vp-header">
  <div>
    <div class="vp-breadcrumb">
      ...
      <a href="/library_entry_system/entries/list.php">All Entries</a>
      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
  ...
  <div class="vp-actions">
    ...
    <a href="/library_entry_system/entries/create.php?copy_from=<?= $r['id'] ?>" class="vp-btn vp-btn-copy">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
      Copy Entry
    </a>
    <?php endif; ?>
    <?php if (can_modify_entries()): ?>
    <a href="/library_entry_system/entries/edit.php?id=<?= $r['id'] ?>" class="vp-btn vp-btn-primary">
    ...
    <?php endif; ?>
    <a href="/library_entry_system/entries/list.php" class="vp-btn vp-btn-secondary">
